...
export default class TypeBuilder {
    ...
    Group: ClassViewer<'Group', "name" | "description">;
    
    GroupResponse: ClassViewer<'GroupResponse', "message">;
    
    PreferencesResponse: ClassViewer<'PreferencesResponse', "preferences">;
    ...
    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "Group","GroupResponse","PreferencesResponse","Resume",
          ]),
          enums: new Set([
        ...
        this.Group = this.tb.classViewer("Group", [
          "name","description",
        ]);
        
        this.GroupResponse = this.tb.classViewer("GroupResponse", [
          "message",
        ]);
        
        this.PreferencesResponse = this.tb.classViewer("PreferencesResponse", [
          "preferences",
        ]);
